 ...
 * @author John Bailey
 */
public class PropertiesExpressionResolver extends JBossASSimpleExpressionResolver {
    private final Properties deploymentProperties;

    public PropertiesExpressionResolver(final Properties deploymentProperties) {
