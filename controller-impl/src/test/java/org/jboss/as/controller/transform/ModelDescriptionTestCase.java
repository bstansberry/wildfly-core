...
public class ModelDescriptionTestCase {
    ...
    public static void setup() {
        registration = ManagementResourceRegistrationFactory.create(RootSubsystemResource.INSTANCE);
    ...
    public void testManagementResourceSerialization() {
        ...
        ManagementResourceRegistration loaded = ManagementResourceRegistrationFactory.create(definition);
