...
import org.jboss.as.controller.registry.OperationEntryImpl;
...
public class BootErrorCollectorTest {
    ...
    private OperationEntry createOperationEntry(EnumSet<OperationEntry.Flag> flags) throws NoSuchMethodException,
        ...
        Constructor<OperationEntryImpl> constructor = OperationEntryImpl.class.getDeclaredConstructor(OperationStepHandler.class, DescriptionProvider.class,
