...
public class NotificationSupportImplTestCase {
    ...
    private void  doNotificationOrdering(ExecutorService executor) throws Exception {
        ...
        Assert.assertEquals(handler.getNotifications().toString(), numberOfNotificationsEmitted, handler.getNotifications().size());
        ...
        Assert.assertEquals(notifications1, handler.getNotifications().subList(0, 3));
        // handled the 1st notifications2 that were emitted
        Assert.assertEquals(notifications2, handler.getNotifications().subList(3, 6));
        // handled the 2nd notifications1 that were emitted
        Assert.assertEquals(notifications1, handler.getNotifications().subList(6, 9));
        // handled the 2nd notifications2 that were emitted
        Assert.assertEquals(notifications2, handler.getNotifications().subList(9, 12));
    }
}
