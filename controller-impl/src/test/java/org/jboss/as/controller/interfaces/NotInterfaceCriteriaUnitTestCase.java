...
public class NotInterfaceCriteriaUnitTestCase {
    ...
    public void testMultipleCriteria() throws Exception {
        if (InterfaceCriteriaTestUtil.nonLoopBackInterfaces.size() < 1) {
            return;
        }


        if (InterfaceCriteriaTestUtil.nonLoopBackInterfaces.contains("bogus")) {
    ...
    public void testNoMatch() throws Exception {
        ...
        for (NetworkInterface ni : InterfaceCriteriaTestUtil.loopbackInterfaces) {
            candidates.put(ni, InterfaceCriteriaTestUtil.allCandidates.get(ni));
        }
