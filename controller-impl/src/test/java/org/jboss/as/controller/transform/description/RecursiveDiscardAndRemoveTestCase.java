...
public class RecursiveDiscardAndRemoveTestCase {
    ...
    private ManagementResourceRegistration resourceRegistration = ManagementResourceRegistrationFactory.create(ROOT);
    ...
    public void setUp() {
        ...
        resourceRegistration = ManagementResourceRegistrationFactory.create(ROOT);
        // test
