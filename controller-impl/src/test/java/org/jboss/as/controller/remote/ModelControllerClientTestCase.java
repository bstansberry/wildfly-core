...
import org.jboss.as.controller.notification.NotificationHandlerRegistrationFactory;
...
public class ModelControllerClientTestCase {
    ...
    private static abstract class MockModelController extends org.jboss.as.controller.MockModelController {
        ...
        private final NotificationHandlerRegistration notificationRegistry = NotificationHandlerRegistrationFactory.create();
