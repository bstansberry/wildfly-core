...
final class OperationContextImpl extends AbstractOperationContext {
     ...
     * @param registryActiveStep the {@link AbstractOperationContext.Step} that encapsulates
     ...
     *
     * @param targetActiveStep the {@link AbstractOperationContext.Step} that encapsulates
     *                           the {@link org.jboss.as.controller.OperationStepHandler} that is making the call.
