...
class ModelControllerImpl implements ModelController {
     ...
     * @param lockPermit lockPermit to use in any {@link ParallelBootOperationContext}
...
//            });
         ...
         * to other callers. Use {@link ModelControllerImpl#writeModel(ModelControllerImpl.ManagementModelImpl, java.util.Set)}
         * to publish changes.
         *
