...
public class TransactionalProtocolOperationHandler implements ManagementRequestHandlerFactory {
    ...
    /**
     * The request handler for requests from {@link TransactionalProtocolClient#execute}.
     */
    ...
    /**
     * The request handler for requests from {@link TransactionalProtocolClientImpl.CompleteTxRequest}
     */
