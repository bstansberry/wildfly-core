...
public abstract class AbstractCapability {
    ...
    protected AbstractCapability(final String name, final Set<String> requirements) {
        assert name != null;
        this.name = name;
     ...
     * {@inheritDoc}
     *
     * @return {@code true} of {@code o} is the same type as this object and its {@link #getName() name} is equal
     */
    @Override
