...
public class GlobalTransformerRegistry {
     ...
     * @param placeholder if {@code true} the pathAddress-, resource-, and operationTransformers are responsible for handling children of their address via a {@link OperationTransformerRegistry.PlaceholderResolver}
     */
