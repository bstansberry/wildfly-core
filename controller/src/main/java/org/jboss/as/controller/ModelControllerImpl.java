...
class ModelControllerImpl implements ModelController {
    ...
    ModelControllerImpl(final ServiceRegistry serviceRegistry, final ServiceTarget serviceTarget,
                        final CloneableManagementResourceRegistration rootRegistration,
    ...
    final class ManagementModelImpl implements ManagementModel {
        // The possibly unpublished root MRR
        private final CloneableManagementResourceRegistration resourceRegistration;
        ...
        ManagementModelImpl(final CloneableManagementResourceRegistration resourceRegistration,
        ...
        ManagementModelImpl cloneRootResourceRegistration() {
            try {
                return new ManagementModelImpl(resourceRegistration.clone(), rootResource);
        ...
        ManagementModelImpl cloneRootResource() {
            return new ManagementModelImpl(resourceRegistration, rootResource.clone());
        }
