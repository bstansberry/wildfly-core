...
public class StringLengthValidator extends ModelTypeValidator implements MinMaxValidator {
    ...
    public void validateParameter(String parameterName, ModelNode value) throws OperationFailedException {
        ...
        if (value.isDefined() && value.getType() != ModelType.EXPRESSION) {
            ...
            if (str.length() < min) {
                throw new OperationFailedException(ControllerLoggerDuplicate.ROOT_LOGGER.invalidMinLength(str, parameterName, min));
            }
            else if (str.length() > max) {
                throw new OperationFailedException(ControllerLoggerDuplicate.ROOT_LOGGER.invalidMaxLength(str, parameterName, max));
            }
        }
    }
