...
import org.wildfly.management.api.extension.Extension;

/**
 * Holds the possible process types. This is used to identify what type of process we are running in.
 * An {@link Extension} can use this information to decide whether certain resources, operations or attributes
 * need to be present. Operation handlers can use this to determine how to handle operations.
 */
