...
/**
 * Callback to be invoked upon completion of normal parsing of a profile that an {@link Extension}
 * can register to allow it to manipulate the list of parsed boot operations associated with that profile.
 *
