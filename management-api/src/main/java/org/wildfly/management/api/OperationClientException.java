 ...
 */
public class OperationClientException extends RuntimeException {
     ...
     */
    public OperationClientException(final String message) {
     ...
     */
    public OperationClientException(final String message, final Throwable cause) {
     ...
     */
    public OperationClientException(final String msg, final ModelNode description) {
        super(msg);
     ...
     */
    public OperationClientException(final Throwable cause) {
     ...
     * @param description the description of the failure. Cannot be {@code null}
     */
    public OperationClientException(final Throwable cause, final ModelNode description) {
        super(cause);
        assert description != null : "description is null";
        failureDescription = description;
    }
     ...
     * @param description the description of the failure. Cannot be {@code null}
     */
    public OperationClientException(final String msg, final Throwable cause, final ModelNode description) {
        super(msg, cause);
        assert description != null : "description is null";
        failureDescription = description;
    }
