 ...
 * prefix.attribute-name.value-type-suffix=The description of an element in a complex attribute's {@code value-type}.
 ...
 * prefix.operation-name.param-name.value-type-suffix=The description of an element in a complex operation parameter's {@code value-type}..
 * prefix.operation-name.reply=The description of an operation's reply value.
 * prefix.operation-name.reply.value-type-suffix=The description of an element in a complex operation reply value's {@code value-type}..
