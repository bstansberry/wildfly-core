 ...
 * <p>
 * Note that use of this interface in no way creates a requirement by the caller on any
...
public interface CapabilityServiceSupport {
     ...
     * the requirements for capability availability available in {@link RuntimeUpdateContext}
